...
public class DoctorDao {
	...
	public boolean registerDoctor(Doctor d) {
		...
		try {
			String sql = "insert into doctor(id,full_name,dob,qualification,specialist,email,mobno,password) values(sq3.nextval,?,?,?,?,?,?,?)";			PreparedStatement ps = conn.prepareStatement(sql);
